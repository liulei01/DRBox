#ifndef CAFFE_MULTIRBOX_LOSS_LAYER_HPP_
#define CAFFE_MULTIRBOX_LOSS_LAYER_HPP_
...
/**
 * @brief Perform MultiRBox operations. Including the following:
 *
...
class MultiRBoxLossLayer : public LossLayer<Dtype> {
 public:
  explicit MultiRBoxLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "MultiRBoxLoss"; }
 ...
 protected:
  ...
  MultiRBoxLossParameter multirbox_loss_param_;
  int num_classes_;
  ...
  bool ignore_cross_boundary_rbox_;
  bool bp_inside_;
...
#endif  // CAFFE_MULTIRBOX_LOSS_LAYER_HPP_
