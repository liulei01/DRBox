...
train_data = "examples/Car/Car_trainval_lmdb"
# The database file for testing data. Created by data/VOC0712/create_data.sh
test_data =  "examples/Car/Car_test_lmdb"
...
job_name = "RBOX_{}_VGG".format(resize)
# The name of the model. Modify it if you want.
model_name = "RBOX_Car_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/RBOX/Car/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/RBOX/Car/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/RBOX/Car/{}".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/data/Car/results/RBOX/{}/Main".format(os.environ['HOME'], job_name)
...
if code_type == P.PriorRBox.CENTER_SIZE:
  ...
  prior_variance = [0.1, 0.1, 0.1] # modified by LL
else:
  prior_variance = [0.1]
rotate_angles = [0.0, 30., 60., 90., 120., 150., 180., 210., 240., 270., 300., 330.]
flip = False
clip = False
